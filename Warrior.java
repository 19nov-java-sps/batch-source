...
public class Warrior extends Human implements Interface {
	...
	public Warrior(String name, int level) {
		...
		this.mana = 1*level;
		this.health = 5*level + 30;
		this.strength = 3*level;
		this.defense = (int) (2.2*level);
		this.magic = 1*level;
	}
	...
	public int magicalAttack() throws Exception {
		...
		else if(mana < 10 && mana >0 && health>0){
			this.mana = 0;
			return magic/2;
		}
		else if(health>0) {
