...
public class Reimbursements {
	...
	public Reimbursements(String reasonForReimbursement, double reimbursementAmount, boolean isPending, int userId,
			int resolvedBy) {
		super();
	...
	public Reimbursements(String reasonfor, double amount, boolean ispending2, int userId2) {
		reasonForReimbursement=reasonfor;
		reimbursementAmount=amount;
		isPending= ispending2;
		userId=userId2;
	}
	public Reimbursements(String reasonfor, double amount, boolean ispending2, int userId2,int resolvedBy1,String status1) {
		reasonForReimbursement=reasonfor;
		reimbursementAmount=amount;
		isPending= ispending2;
		userId=userId2;
	...
	public Reimbursements(String reasonForReimbursement, double reimbursementAmount, boolean isPending, int userId,String status1) {
		super();
		this.reasonForReimbursement = reasonForReimbursement;
		this.reimbursementAmount = reimbursementAmount;
		this.isPending = isPending;
