...
public class RacingBicycle extends Bicycle{
	...
	//let RacingBicycle inherit from Bicycle
	public RacingBicycle() {
		super();
	}
	
	//created RacingBicycle object
	public RacingBicycle(String model) {
		this ();
		this.model = model;
	...
	public String toString() {
		return "RacingBicycle [Model is " + model +"]";
	}
    ...
    if(this == obj) 
     ...
     if(obj == null || obj.getClass()!= this.getClass()) 
     	...
     	RacingBicycle race = (RacingBicycle) obj; 

        return (race.model == this.model); 
    

	}
	
	//converts string model to hashcode
	@Override
	public int hashCode() 
    { 
