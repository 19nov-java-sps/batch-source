...
function displayPendingReimbursements(reimbursementsJSON){
	...
	for(let reimbursement of reimbursements){
		...
		newRow.innerHTML= `<td>${reimbursement.reasonForReimbursement}</td><td>${reimbursement.reimbursementAmount}</td><td>${reimbursement.userId}</td><td>${reimbursement.pending}</td>`;
