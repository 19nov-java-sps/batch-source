...
let invoiceURL = "http://localhost:8080/Project1-Hibernate/api/invoices";
let loginURL = "http://localhost:8080/Project1-Hibernate/login";
let userURL = "http://localhost:8080/Project1-Hibernate/api/users";
...
if(!token){
	window.location.href="http://localhost:8080/Project1-Hibernate/login";
} else {
	let tokenArr = token.split(":");
	if (tokenArr[0] === "0") {
	...
	if(tokenArr.length===2){
		let baseUrl = "http://localhost:8080/Project1-Hibernate/api/users?id=";
...
function sendAjaxDenied(e){
	...
	let url = "http://localhost:8080/Project1-Hibernate/denied";
	let xhr = new XMLHttpRequest();
	xhr.open("POST", url);
	xhr.onreadystatechange = function(){
		if(this.readyState === 4 && this.status===200){
		let auth = xhr.getResponseHeader("Authorization");
		window.location.href="http://localhost:8080/Project1-Hibernate/home";
...
function sendAjaxApproved(e){
	...
	let url = "http://localhost:8080/Project1-Hibernate/approved";
	let xhr = new XMLHttpRequest();
	xhr.open("POST", url);
	xhr.onreadystatechange = function(){
		if(this.readyState === 4 && this.status===200){
...
function sendAjaxResolved(){
	let url = "http://localhost:8080/Project1-Hibernate/resolved";
	let xhr = new XMLHttpRequest();
	xhr.open("POST", url);
	xhr.onreadystatechange = function(){
		if(this.readyState === 4 && this.status===200){
...
function sendAjaxInvoice(){
	let url = "http://localhost:8080/Project1-Hibernate/new-invoice";
	let xhr = new XMLHttpRequest();
	xhr.open("POST", url);
	xhr.onreadystatechange = function(){
		if(this.readyState === 4 && this.status===200){
...
function sendAjaxUpdate(){
	let url = "http://localhost:8080/Project1-Hibernate/update";
	let xhr = new XMLHttpRequest();
	xhr.open("POST", url);
	xhr.onreadystatechange = function(){
		if(this.readyState === 4 && this.status===200){
...
function sendAjaxGetProfile(url, callback){
	let xhr = new XMLHttpRequest();
	xhr.open("GET", "http://localhost:8080/Project1-Hibernate/api/users?id=1");
	xhr.onreadystatechange = function(){
		if(this.readyState===4 && this.status===200){
			displayUserProfile(this);
		}
